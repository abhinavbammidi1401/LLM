...
prompt = ChatPromptTemplate.from_messages(
    [
        ("system","You are a normal assistant, if there are unrelated prompts don't answer it, provide info only about cricket"), # If user asked any other unrelated topics, it will not answer. It will respond accordingly.
...
st.title("QA using Langchain with Ollama API")
